  ...
  Parsley.addMessages('en', {
    ...
    type: {
      ...
      // alphanum: "This value should be alphanumeric."
        ...
        integer: "Vui lòng nhập đúng định dạng số nguyên.",
    ...
    // equalto: "This value should be the same."
      notblank: "Giá trị này không nên để trống",
      required: "Trường này không được để trống",
      pattern: "Giá trị này không đúng định dạng",
      min: "Vui lòng nhập lớn hơn hoặc bằng %s.",
      max: "Vui lòng nhập nhỏ hơn hoặc bằng  %s.",
      range: " Giá trị này phải nằm giữa %s và %s.",
      minlength: "Vui lòng nhập %s ký tự trở lên.",
      maxlength: "Vui lòng nhập %s ký tự hoặc ít hơn.",
      length: "Vui lòng nhập %s hoặc %s ký tự",
